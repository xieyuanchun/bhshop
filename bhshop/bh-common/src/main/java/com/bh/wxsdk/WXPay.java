...
//        }
    ...
    /*	reqData.put("nonce_str", nonce_str);
    	...
    	Map<String,String> retMap = wxp.unifiedOrder(reqData);
    	System.out.println("retMap--->"+retMap);
    }
    public static Map<String,String> unifiedOrder(WxJsUnifiedOrderEntity entity) throws Exception{
    	WXPay wxp = new WXPay(new WXPayConfig() {
			@Override
			IWXPayDomain getWXPayDomain() {
				// TODO Auto-generated method stub
    	...
    	Map<String,String> reqData = new HashMap<String,String>();
    	reqData.put("body", entity.getBody());
    	reqData.put("out_trade_no", entity.getOutTradeNo());
    	reqData.put("total_fee", entity.getTotalFee());
    	reqData.put("trade_type", entity.getTradeType());
    	reqData.put("notify_url", entity.getNotifyUrl());
    	reqData.put("openid", entity.getOpenid());
    	Map<String,String> retMap = wxp.unifiedOrder(reqData);
    	return retMap;
