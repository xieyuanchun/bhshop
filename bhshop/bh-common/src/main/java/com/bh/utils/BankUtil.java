...
public class BankUtil {  
    public static void main(String[] args) { 
        String cardNumber = "6236683320023723448";//卡号  
        String cardNumber1 = "6235757000003454189";//卡号  
        String cardNumber2 = "6212263602093433621";//卡号  
        String name = getNameOfBank(cardNumber);   
        String name1 = getNameOfBank(cardNumber1);
