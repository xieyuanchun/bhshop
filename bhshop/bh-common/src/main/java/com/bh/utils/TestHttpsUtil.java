...
//            }
    ...
    //	System.out.println("url  9999999--->"+url);
    ...
    public static String doPost(String url, JSONObject json) throws Exception {
    	return doPost(url,jsonToParam(json));
    }
...
//			System.out.println("json:"+json.toJSONString());
	 ...
	 public static String jsonToParam(JSONObject json) throws Exception {
		 return mapToParam((Map)json);
	 }
     ...
     *
     * @param data 待转数据
     * @return  name1=value1&name2=value2 的形式。
     */
    public static String mapToParam(final Map<String, String> data) throws Exception {
