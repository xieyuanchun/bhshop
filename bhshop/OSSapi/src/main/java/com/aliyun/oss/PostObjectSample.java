...
public class PostObjectSample {
   ...
   // private String bucketName = "<bucketName>";
	...
	String[] keyNa=osstoken.setKey();
	String endpoint=keyNa[0];
	String accessKeyId=keyNa[1];
	String accessKeySecret=keyNa[2];
	String bucketName=keyNa[3];
	
	public String PostObject(String localFilePath,String key) throws Exception {
