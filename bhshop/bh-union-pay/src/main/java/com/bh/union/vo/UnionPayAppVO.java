...
* @date 2018年1月20日  新建  
*/
public class UnionPayAppVO {
	
	public String md5Key;
	public String msgId;//消息ID，原样返回
	public String msgSrc = "WWW.SHZSHWLKJ.COM";//消息来源
	
	public String msgType="wx.unifiedOrder";//消息类型
	public String requestTimestamp;//报文请求时间，格式yyyy-MM-dd HH:mm:ss
	public String merOrderId;//商户订单号
	public String srcReserve;//请求系统预留字段
	public String mid="898445148160121";//商户号     h5:898310060514010 web:898310060514001
	public String tid="67200479";//终端号
	public String instMid="APPDEFAULT";//业务类型 H5DEFAULT
