...
public interface GoodsCategoryService {
	...
	/*修改分类*/
	int updateCategory(String id, String sortnum, String image, String flag,String name) throws Exception;
	...
	/*首页分类显示前6条商品*/
	List<GoodsCategory> selectTopSixGoodsBycatId() throws Exception;
