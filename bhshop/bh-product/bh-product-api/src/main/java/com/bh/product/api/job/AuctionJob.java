...
import com.bh.product.api.service.TopicDauctionService;
 ...
 */
@JobHander(value="auctionJob")
@Component
public class AuctionJob extends IJobHandler {
	@Autowired
	private TopicDauctionService topicDauctionService;
	@Override
	public synchronized ReturnT<String> execute(String... params) throws Exception {
		topicDauctionService.changeGoodsPrice();
