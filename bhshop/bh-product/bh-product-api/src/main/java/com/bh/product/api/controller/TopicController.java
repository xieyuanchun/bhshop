...
import com.bh.product.api.enums.LocationEnum;
import com.bh.product.api.service.TopicGoodsService;
...
//			}
    ...
    public BhResult getOpenidTwo(String code,HttpServletRequest request, HttpServletResponse response) throws Exception {
		BhResult r = null;
		try {
			String retUrl = request.getSession(false).getServletContext().getRealPath("/");
