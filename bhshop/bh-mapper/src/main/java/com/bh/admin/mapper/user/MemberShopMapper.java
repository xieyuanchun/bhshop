...
import com.bh.admin.pojo.user.SysLog;
...
public interface MemberShopMapper {
    ...
    List<MemberShop> selectByShopName(String shopName);
    ...
    //查询商家的名称
    String selectShopName(Integer mId);
    //结束

    //统计审核通过的商家总数
	int countShopCheckPass();
