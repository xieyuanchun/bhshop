...
public class JedisUtil { 
	 ...
	 private JedisUtil() {   
	  ...
	  static {
	        ...
	        // jedisPool = new JedisPool(config, "120.77.155.160", 6379,10000,"zy5f59e41cb7be6");
	         FileInputStream in = null;
	         try{
	 			Properties properties = new Properties();
	 			String path=JedisUtil.class.getResource("/resource/resource.properties").getFile();
	 			in = new FileInputStream(path);
	 			properties.load(in);
	 			jedisPool = new JedisPool(config, properties.getProperty("redis_hostname"), Integer.parseInt(properties.getProperty("redis_port")),10000,properties.getProperty("redis_pwd"));
	 		}catch(Exception e){
	 			e.printStackTrace();
	...
	public long time() {
		Jedis jedis = getJedis();
		List<String> listString=jedis.time();
		returnJedis(jedis);
		return Long.valueOf(listString.get(0))*1000;
	}
...
*/
	...
	public static void main(String[] args) {
		...
		String obj = strings.get("7f2f3e27c05e81f4ce51359c9ee0f391");
