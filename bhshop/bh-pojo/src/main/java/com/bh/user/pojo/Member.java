...
public class Member implements Serializable{
    ...
    private Date changePhoneTime;
    
    
    
    

	public Date getChangePhoneTime() {
		return changePhoneTime;
	}

	public void setChangePhoneTime(Date changePhoneTime) {
		this.changePhoneTime = changePhoneTime;
	}
