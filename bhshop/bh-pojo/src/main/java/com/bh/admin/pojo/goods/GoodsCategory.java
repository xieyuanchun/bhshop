...
public class GoodsCategory {
    ...
    private Integer isNew; //是否是新增分类 0不是 1是
    
    private List<GoodsCategory> childList;//下级分类列表
    
    private GoodsCategory childGoodsCategory;//下级分类列表
    
    

	public GoodsCategory getChildGoodsCategory() {
		return childGoodsCategory;
	}

	public void setChildGoodsCategory(GoodsCategory childGoodsCategory) {
