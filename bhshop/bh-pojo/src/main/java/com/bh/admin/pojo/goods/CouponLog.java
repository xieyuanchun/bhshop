...
public class CouponLog {
    ...
    private String strCouponStatus;
	...
	public String getStrCouponStatus() {
		return strCouponStatus;
	}

	public void setStrCouponStatus(String strCouponStatus) {
		this.strCouponStatus = strCouponStatus;
	}
