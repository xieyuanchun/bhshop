...
public class OrderShop implements Serializable {
	...
	private Date validLen;
	
	private Integer couponId;
	private Integer couponPrice;
	private Integer isRefund2;
	...
	private  List<Map<Object,Object>> orderSku1;
	...
	public List<Map<Object, Object>> getOrderSku1() {
		return orderSku1;
	}

	public void setOrderSku1(List<Map<Object, Object>> orderSku1) {
		this.orderSku1 = orderSku1;
	}
	...
	public String getMystatus() {
		...
		/* switch (mystatus) {
		  ...
		  case "0": return "货到付款";//支付状态:0货到付款,1待付款（未支付）,2已付款（已支付）,3待退款,4退款成功,5退款失败 ，默认是1待支付 
		  case "1": return"待付款（未支付）"; 
		  case "2": return "已付款（已支付）"; 
		  case "3": return "待退款"; 
		  case"4": return "退款成功"; 
		  case "5": return "退款失败"; 
		  default: return "";
	...
	public Integer getIsRefund2() {
		return isRefund2;
	}

	public void setIsRefund2(Integer isRefund2) {
		this.isRefund2 = isRefund2;
	}
