...
public class Goods implements Serializable{
    ...
    private AuctionConfig auctionConfig;//荷兰式配置信息
    ...
    private String appDescription; //app移动端介绍
    
    private String webDescription; //web端介绍
    
    private String paramData; //模型规格
    
    private Integer userId; //操作用户id
    
    private List<GoodsSku> addSkuList; //新增sku
    
    private String[] deleteSkuList;//删除sku
	...
	public List<GoodsSku> getAddSkuList() {
		return addSkuList;
	}

	public void setAddSkuList(List<GoodsSku> addSkuList) {
		this.addSkuList = addSkuList;
	}

	public String[] getDeleteSkuList() {
		return deleteSkuList;
	}

	public void setDeleteSkuList(String[] deleteSkuList) {
